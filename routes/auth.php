...
Route::middleware('guest')->group(function () {
    ...
    // -----------------------------------------------------------------
    // Public Registration (Students and Vendors via single shared form)
    // -----------------------------------------------------------------
    ...
    // -----------------------------------------------------------------
    // Hidden Admin Registration (Protected via Secret Key check)
    // -----------------------------------------------------------------
// -----------------------------------------------------------------
// Dedicated Admin Login Tracks
// -----------------------------------------------------------------
...
Route::middleware('auth')->group(function () {
    // -----------------------------------------------------------------
    // Email Verification & Session Protections
    // -----------------------------------------------------------------

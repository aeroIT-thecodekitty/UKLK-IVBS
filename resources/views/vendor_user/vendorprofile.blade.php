<x-app-layout>
    ...
    <div class="flex min-h-screen bg-gray-100 dark:bg-gray-900" x-data="{ sidebarOpen: true }">
        ...
        <main class="flex-1 p-8 space-y-6">
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 pb-4">
                ...
                <p class="text-xs text-gray-500 mt-1">Manage your vendor portal identity details and account status verification nodes.</p>
            </div>
            ...
            <div class="max-w-3xl bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="h-32 bg-gradient-to-r from-[#1B49A6] to-[#163D8C] p-6 flex items-end">
                ...
                <div class="pt-14 p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <span class="inline-block mt-1 px-3 py-0.5 text-[10px] font-bold bg-amber-50 text-amber-700 border border-amber-200 rounded-full uppercase">
                            Vendor Merchant Operator
                        </span>
                    </div>

    ...
    <div class="flex min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <main class="flex-1 p-8 space-y-6">
            <div class="border-b border-gray-200 dark:border-gray-700 pb-4">
                <h2 class="font-bold text-2xl text-gray-800 dark:text-gray-200 leading-tight">Edit Parking Slot: {{ $stall->stall_number }}</h2>
            </div>

            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm max-w-2xl">
                <form action="{{ route('admin_user.stall_parking_update', $stall->id) }}" method="POST" class="space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="stall_number" value="{{ old('stall_number', $stall->stall_number) }}" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm shadow-sm focus:border-purple-500 focus:ring-purple-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="location" value="{{ old('location', $stall->location) }}" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm shadow-sm focus:border-purple-500 focus:ring-purple-500">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" name="total_slots" value="{{ old('total_slots', $stall->total_slots) }}" required min="1" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm shadow-sm focus:border-purple-500 focus:ring-purple-500">
                        ...
                        <div>
                            ...
                            <select name="status" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm shadow-sm focus:border-purple-500 focus:ring-purple-500">
                                <option value="available" {{ old('status', $stall->status) == 'available' ? 'selected' : '' }}>Available</option>
                                <option value="maintenance" {{ old('status', $stall->status) == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" step="0.01" name="student_rate" value="{{ old('student_rate', $stall->student_rate) }}" required min="0" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm shadow-sm focus:border-purple-500 focus:ring-purple-500">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="vendor_rate" value="{{ old('vendor_rate', $stall->vendor_rate) }}" required min="0" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm shadow-sm focus:border-purple-500 focus:ring-purple-500">

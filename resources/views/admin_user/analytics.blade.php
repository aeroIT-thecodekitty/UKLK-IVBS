    ...
    <div class="flex min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <main class="flex-1 p-8 space-y-6 overflow-x-hidden">
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 pb-4">
                ...
                <p class="text-xs text-gray-500 mt-1">Real-time revenue audits, asset utilization tracking, and registration statistics across the network.</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-between">
                    ...
                    <div class="text-2xl font-black text-orange-600 mt-2">{{ $totalPendingRequests }} Request Nodes</div>
                    <div class="text-[11px] text-orange-500 font-medium mt-2 animate-pulse">● Requires manual verification step</div>
                </div>

                <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-between">
                    <div class="text-gray-400 dark:text-gray-400 text-xs font-bold uppercase tracking-wider">Active Borrowed Equipment</div>
                    <div class="text-2xl font-black text-blue-600 mt-2">{{ $activeLoansCount }} Active Loans</div>
                    <div class="text-[11px] text-gray-400 mt-2">Outstanding physical gear currently off-deck.</div>
                </div>

                <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-between">
                    <div class="text-gray-400 dark:text-gray-400 text-xs font-bold uppercase tracking-wider">Total Core Users</div>
                ...
                <div class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <div class="bg-red-50 dark:bg-red-950/20 px-5 py-4 border-b border-red-100 dark:border-red-900 flex items-center justify-between">
                        <h3 class="text-sm font-black text-red-800 dark:text-red-400 uppercase tracking-wide flex items-center gap-1.5">
                            🚨 Overdue Equipment Return Alert List
                        </h3>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="p-8 text-center text-gray-400 italic font-medium bg-gray-50/30">
                                            Awesome! All equipment has been safely returned to the logistics deck on schedule.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                        ...
                        <div class="p-5 space-y-4">
                            ...
                            @empty
                                <div class="text-xs text-gray-400 italic text-center py-12">
                                    No custom return conditions or damage logs tracked in recent cycles.
                                </div>
                            @endforelse
                        </div>
                    </div>

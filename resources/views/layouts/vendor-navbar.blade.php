<header class="w-full bg-[#0B318F] text-white flex items-center justify-between px-6 py-3 shadow-md z-20">
    ...
    <nav class="flex items-center gap-6 text-sm font-semibold tracking-wide">
        <a href="{{ route('vendor.home') }}" class="hover:text-amber-400 transition no-underline">Home</a>
        
        <a href="{{ route('vendor.profile') }}" class="hover:text-amber-400 transition no-underline">My Profile</a>
    </nav>
</header>